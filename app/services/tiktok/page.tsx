      ...
      <section className="relative pt-32 pb-20 overflow-hidden min-h-[80vh] flex items-center">
        ...
        <div className="container relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            >
              TikTok Marketing <span className="text-pink-400">Coming Soon</span>
            </motion.h1>
            <motion.p 
            ...
            >
              We're working on adding TikTok marketing. Soon you'll be able to use our service to promote on TikTok!
            </motion.p>
            <motion.div 
